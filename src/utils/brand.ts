import brandLogo from '../assets/images/fox_brand_logo_1787738690434.jpg';

export const BRAND_LOGO_SRC = brandLogo;
export const BRAND_NAME = 'Prajwal Pokharel';
export const BRAND_TITLE = 'BSc CSIT Student & Tech Learner';
